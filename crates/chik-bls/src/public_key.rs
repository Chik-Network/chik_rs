...
use chik_traits::{Streamable, read_bytes};
...
impl serde::Serialize for PublicKey {
    ...
    where
        S: serde::Serializer,
    {
        chik_serde::ser_bytes(&self.to_bytes(), serializer, true)
    }
}
...
impl<'de> serde::Deserialize<'de> for PublicKey {
    ...
    {
        Self::from_bytes(&chik_serde::de_bytes(deserializer)?).map_err(serde::de::Error::custom)
    }
}
