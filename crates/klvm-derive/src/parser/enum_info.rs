...
use super::{KlvmOptions, Repr, VariantInfo, parse_klvm_options, parse_variant};
...
pub fn parse_enum(mut options: KlvmOptions, data_enum: &DataEnum) -> EnumInfo {
    assert!(
    ...
    for variant in &data_enum.variants {
        let variant_options = parse_klvm_options(&variant.attrs);
