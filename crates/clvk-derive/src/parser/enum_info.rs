...
use super::{ClvkOptions, Repr, VariantInfo, parse_clvk_options, parse_variant};
...
pub fn parse_enum(mut options: ClvkOptions, data_enum: &DataEnum) -> EnumInfo {
    assert!(
    ...
    for variant in &data_enum.variants {
        let variant_options = parse_clvk_options(&variant.attrs);
