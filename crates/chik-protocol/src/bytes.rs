...
impl serde::Serialize for Bytes {
    ...
    where
        S: serde::Serializer,
    {
        chik_serde::ser_bytes(self, serializer, false)
    }
}
...
impl<'de> serde::Deserialize<'de> for Bytes {
    ...
    {
        chik_serde::de_bytes(deserializer)
    }
}
...
impl<const N: usize> serde::Serialize for BytesImpl<N> {
    ...
    where
        S: serde::Serializer,
    {
        chik_serde::ser_bytes(self, serializer, true)
    }
}
...
impl<'py, const N: usize> IntoPyObject<'py> for BytesImpl<N> {
    ...
    fn into_pyobject(self, py: Python<'py>) -> Result<Self::Output, Self::Error> {
        ChikToPython::to_python(&self, py)
    }
}
