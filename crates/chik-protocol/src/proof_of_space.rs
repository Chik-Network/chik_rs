...
impl ProofOfSpace {
    pub fn param(&self) -> chik_error::Result<PlotParam> {
        match self.version_and_size & 0b1100_0000 {
            ...
            _ => Err(chik_error::Error::InvalidPoSVersion),
        }
    }
}
...
mod tests {
    ...
    #[case(0xff, Err(chik_error::Error::InvalidPoSVersion))]
    #[case(0x7f, Err(chik_error::Error::InvalidPoSVersion))]
    fn proof_of_space_size(#[case] size_field: u8, #[case] expect: chik_traits::Result<PlotParam>) {
