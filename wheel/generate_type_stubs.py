...
def generator_interned_vbytes(program: ReadableBuffer) -> int: ...
...
def validate_proof_v2(plot_id: bytes32, size: int, challenge: bytes32, plot_strength: int, proof: bytes, testnet: bool) -> Optional[bytes32]: ...

def solve_proof(fragments: PartialProof, plot_id: bytes32, strength: int, k: int, testnet: bool) -> bytes: ...
